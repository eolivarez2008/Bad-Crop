...
const ITEMS := [
	{ "id": "max_health", "label": "❤️ Vie Max +20", "cost": 30 },
	{ "id": "speed", "label": "👟 Vitesse +20", "cost": 25 },
	{ "id": "damage_left", "label": "⚔️ Dégâts G +5", "cost": 20 },
	{ "id": "damage_right", "label": "⚔️ Dégâts D +5", "cost": 20 },
	{ "id": "firerate_left", "label": "⚡ Cadence G +0.1", "cost": 35 },
	{ "id": "firerate_right", "label": "⚡ Cadence D +0.1", "cost": 35 },
]
...
func _refresh_display() -> void:
	pepper_display.text = "🌶 " + str(_player.peppers)
